...
- The file SHALL live at `openspec/memory/constitution.md` in the project repo
...
- The agent SHALL read `openspec/memory/constitution.md` BEFORE running any fingerprinting
...
## Contexto
> 💡 **Consejo de MentorKit**: Antes de trabajar en esta spec, usa:
